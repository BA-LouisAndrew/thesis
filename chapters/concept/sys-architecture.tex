...
\footnotetext{Cache memories are small, but extremely fast memory used in computer systems to store information that are going to be accessed in a small-time frame \autocite{smith-1982}}