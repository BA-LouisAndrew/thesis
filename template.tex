...
\lstdefinelanguage{js}{
  ...
  % Built-ins.
  morekeywords=[3]{eval, parseInt, parseFloat, escape, unescape, GenericObject, Condition, BooleanCondition, RetryStrategy, ValidationRule,  ValidationAdditionalInfo, ValidationEvent, ValidationEventStatus, Validation}, % Custom types
  sensitive,
  morecomment=[s]{/*}{*/},
  morecomment=[l]//,
