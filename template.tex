...
\lstdefinelanguage{js}{
  ...
  % Built-ins.
  morekeywords=[3]{eval, parseInt, parseFloat, escape, unescape, GenericObject, Condition, BooleanCondition, RetryStrategy, ValidationRule,  ValidationAdditionalInfo, ValidationEvent, ValidationEventStatus, Validation, ValidationSchedule, WentWrong, ValidationErrorJSON, Customer, ApiResponse}, % Custom types
  sensitive,
  morecomment=[s]{/*}{*/},
  morecomment=[l]//,
